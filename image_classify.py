...
CLASSIFY_PROMPT = (
    ...
    "façade, street view of the building), \"plans\" (ONLY a technical "
    "architectural DRAWING — a 2D floor plan / layout diagram with line-drawn "
    "room outlines, dimensions or text labels on a flat white or greyscale "
    "background; it is a drawing, NOT a camera photograph), \"interjers\" (an "
    "interior view of a room shot from inside), \"cits\" (anything else — "
    "aerial, courtyard, parking, neighbourhood, sign, abstract texture, etc.).\n"
    "CRITICAL: a real PHOTOGRAPH is NEVER \"plans\". If the image shows an "
    "actual room — furniture, walls, floor, ceiling, windows, colours or "
    "lighting (even an empty or open-plan hall) — it is \"interjers\" (or "
    "\"fasade\" if outdoors), never \"plans\". Pick \"plans\" only for a "
    "drawn/rendered diagram, not for any camera photo of a real space.\n"
